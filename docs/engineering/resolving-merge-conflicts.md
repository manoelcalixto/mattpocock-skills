...
Start a new Codex thread and type `$mattpocock-skills:resolving-merge-conflicts`.

[Source](https://github.com/manoelcalixto/mattpocock-skills/tree/main/skills/engineering/resolving-merge-conflicts)
...
Type `$mattpocock-skills:resolving-merge-conflicts`, or the agent reaches for it automatically when a task fits.
