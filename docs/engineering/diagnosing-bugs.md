...
Start a new Codex thread and type `$mattpocock-skills:diagnosing-bugs`.

[Source](https://github.com/manoelcalixto/mattpocock-skills/tree/main/skills/engineering/diagnosing-bugs)
...
Type `$mattpocock-skills:diagnosing-bugs`, or the agent reaches for it automatically when a task fits — it fires on "diagnose" / "debug this", or when you report something broken, throwing, failing, or slow.
