...
- A marked run aggregates the final-history and ticket-evidence union for every applicable preflight decision only after review fixes, then creates the implementation checkpoint from the final reviewed head.
