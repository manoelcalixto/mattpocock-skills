...
Use the native plugin for Claude Code or Codex. The Codex plugin contains 25 promoted upstream skills plus the Codex Planning context workflow. Other agents can copy the upstream skills with [skills.sh](https://skills.sh/mattpocock/skills).
...
Invoke a skill as `$mattpocock-skills-codex:<skill-name>`. This is the supported Codex installation route for the adapted skills and their bundled resources.

</details>

<details>
<summary><strong>Other agents and editable copies</strong></summary>

Use skills.sh to copy the upstream skill files when you need editable copies or another agent harness:
...
In Codex, invoke `$mattpocock-skills-codex:setup-matt-pocock-skills`. In Claude Code, invoke `/setup-matt-pocock-skills`. Run it once per repo. It will:
