...
- **This repo's issues.** `gh issue list --repo manoelcalixto/mattpocock-skills --search "<skill-name>" --state all`. A question filed twice is a question the page owes an answer to.
