...
- **[implement-spec](./implement-spec/SKILL.md)**: Implement a whole spec on one branch. Works the tickets as a task graph, then runs one bounded review checkpoint on the integrated result before the PR moves to human review. User-invoked.
