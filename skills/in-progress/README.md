...
- **[delegate-handoff](./delegate-handoff/SKILL.md)** — Hand the current conversation to a fresh Codex V1/V2 agent with isolated, curated context and a `/new` artifact fallback. User-invoked.
