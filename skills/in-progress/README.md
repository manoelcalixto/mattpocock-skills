...
- **[delegate-handoff](./delegate-handoff/SKILL.md)** — Hand the current conversation to a fresh GPT-5.6 Sol MultiAgent V2 worker with isolated, curated context and a `/new` artifact fallback. User-invoked.
