...
- **[research](./research/SKILL.md)** — Investigate a question against high-trust primary sources and capture the findings as a cited Markdown file, delegating safely when agents are available.
...
- **[orchestrate-agents](./orchestrate-agents/SKILL.md)** — Coordinate bounded Codex V1/V2 delegation with isolated briefs, capacity limits, shared-filesystem safety, and sequential fallback.
