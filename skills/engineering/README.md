...
- **[implement](./implement/SKILL.md)** — Build the work described by a spec or set of tickets, using TDD at pre-agreed seams and closing with a two-axis code review.
...
- **[research](./research/SKILL.md)** — Investigate a question against high-trust primary sources and capture the findings as a cited Markdown file, delegating safely through MultiAgent V2 when available.
...
- **[orchestrate-agents](./orchestrate-agents/SKILL.md)** — Coordinate bounded GPT-5.6 Sol delegation through Codex MultiAgent V2 with adaptive effort, isolated briefs, event-driven waiting, capacity limits, shared-filesystem safety, and sequential fallback.
